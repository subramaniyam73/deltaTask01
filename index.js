...
if(screen.width>=320&&screen.width<=1024)
{
  sw=screen.width;
  sww=sw/7;
  document.querySelector(".leftHiding").style.left=-sw/7+"px";
  document.querySelector(".rightHiding").style.right=-sw/7+"px";
...
if(screen.width>1024)
  ...
  if(screen.width>=320&&screen.width<=1024)
  {
    ...
    conNode21.classList.add("num");
    conNode1.style.top="0px";
    conNode1.style.right=sww*4+"px";
    conNode2.style.top="0px";
    conNode2.style.right=sww*3+"px";
    conNode3.style.top="0px";
    conNode3.style.right=sww*2+"px";
    conNode4.style.top="0px";
    conNode4.style.right=sww*1+"px";
    conNode5.style.top="0px";
    conNode5.style.right="0px";
    conNode21.style.top="0px";
    conNode21.style.right=-sww+"px";
    conInterval=setInterval(function(){
      conCount++;
      conNode1.style.right=sww*4+conCount*1+"px";
      conNode2.style.right=sww*3+conCount*1+"px";
      conNode3.style.right=sww*2+conCount*1+"px";
      conNode4.style.right=sww*1+conCount*1+"px";
      conNode5.style.right=0+conCount*1+"px";
      conNode21.style.right=-sww+conCount*1+"px";
      if(Number(conNode1.style.right.slice(0,3))>=sww*4&&conFlag==1)
      {
        conFlag=2;
        /*conTemp=conNode6;
        document.querySelector(".container").removeChild(conTemp);
        ...
        conNode21.style.opacity="0";
        conClass=conNode1.classList[1];
        document.querySelectorAll("."+conClass)[1].style.height="150px";
        document.querySelectorAll("."+conClass)[1].style.width=sww+"px";
        document.querySelectorAll("."+conClass)[1].style.opacity="1";
      ...
      if(Number(conNode1.style.right.slice(0,3))>=sww*5)
      {
        conFlag=1;
        conTemp=conNode1;
        conNode1=conNode2;
    ...
    document.querySelector(".container").appendChild(conNode22);
    conNode22.classList.add("num");
    conNode6.style.top="150px";
    conNode6.style.left="0px";
    conNode7.style.top="150px";
    conNode7.style.left=sww*1+"px";
    conNode8.style.top="150px";
    conNode8.style.left=sww*2+"px";
    conNode9.style.top="150px";
    conNode9.style.left=sww*3+"px";
    conNode10.style.top="150px";
    conNode10.style.left=sww*4+"px";
    conNode22.style.top="150px";
    conNode22.style.left=-sww+"px";
    conInterval2=setInterval(function(){
      conNode6.style.top="150px";
      ...
      conCount2++;
      conNode10.style.left=sww*4+conCount2*1+"px";
      conNode9.style.left=sww*3+conCount2*1+"px";
      conNode8.style.left=sww*2+conCount2*1+"px";
      conNode7.style.left=sww+conCount2*1+"px";
      conNode6.style.left=0+conCount2*1+"px";
      conNode22.style.left=-sww+conCount2*1+"px";
      if(Number(conNode10.style.left.slice(0,3))>=sww*4&&conFlag2==1)
      {
        conFlag2=2;
        /*conTemp=conNode6;
        document.querySelector(".container").removeChild(conTemp);
        ...
        conNode22.style.opacity="0";
        conClass2=conNode10.classList[1];
        document.querySelectorAll("."+conClass2)[1].style.height="150px";
        document.querySelectorAll("."+conClass2)[1].style.width=sww+"px";
        document.querySelectorAll("."+conClass2)[1].style.opacity="1";
      ...
      if(Number(conNode10.style.left.slice(0,3))>=sww*5)
      {
        conFlag2=1;
        conTemp2=conNode10;
        conNode10=conNode9;
    ...
    document.querySelector(".container").appendChild(conNode23);
    conNode23.classList.add("num");
    conNode11.style.top="300px";
    conNode11.style.right=sww*4+"px";
    conNode12.style.top="300px";
    conNode12.style.right=sww*3+"px";
    conNode13.style.top="300px";
    conNode13.style.right=sww*2+"px";
    conNode14.style.top="300px";
    conNode14.style.right=sww*1+"px";
    conNode15.style.top="300px";
    conNode15.style.right="0px";
    conNode23.style.top="300px";
    conNode23.style.right=-sww+"px";
    conInterval3=setInterval(function(){
      conCount3++;
      conNode11.style.right=sww*4+conCount3*1+"px";
      conNode12.style.right=sww*3+conCount3*1+"px";
      conNode13.style.right=sww*2+conCount3*1+"px";
      conNode14.style.right=sww*1+conCount3*1+"px";
      conNode15.style.right=0+conCount3*1+"px";
      conNode23.style.right=-sww+conCount3*1+"px";
      if(Number(conNode11.style.right.slice(0,3))>=sww*4&&conFlag3==1)
      {
        conFlag3=2;
        /*conTemp=conNode6;
        document.querySelector(".container").removeChild(conTemp);
        ...
        conNode23.style.opacity="0";
        conClass3=conNode11.classList[1];
        document.querySelectorAll("."+conClass3)[1].style.height="150px";
        document.querySelectorAll("."+conClass3)[1].style.width=sww+"px";
        document.querySelectorAll("."+conClass3)[1].style.opacity="1";
      ...
      if(Number(conNode11.style.right.slice(0,3))>=sww*5)
      {
        conFlag3=1;
        conTemp3=conNode11;
        conNode11=conNode12;
    ...
    document.querySelector(".container").appendChild(conNode24);
    conNode24.classList.add("num");
    conNode16.style.top="450px";
    conNode16.style.left="0px";
    conNode17.style.top="450px";
    conNode17.style.left=sww*1+"px";
    conNode18.style.top="450px";
    conNode18.style.left=sww*2+"px";
    conNode19.style.top="450px";
    conNode19.style.left=sww*3+"px";
    conNode20.style.top="450px";
    conNode20.style.left=sww*4+"px";
    conNode24.style.top="450px";
    conNode24.style.left=-sww+"px";
    conInterval4=setInterval(function(){
      conNode6.style.top="450px";

      conNode7.style.top="450px";

      conNode8.style.top="450px";

      conNode9.style.top="450px";

      conNode10.style.top="450px";

      conNode22.style.top="450px";


      conCount4++;
      conNode20.style.left=sww*4+conCount4*1+"px";
      conNode19.style.left=sww*3+conCount4*1+"px";
      conNode18.style.left=sww*2+conCount4*1+"px";
      conNode17.style.left=sww+conCount4*1+"px";
      conNode16.style.left=0+conCount4*1+"px";
      conNode24.style.left=-sww+conCount4*1+"px";
      if(Number(conNode20.style.left.slice(0,3))>=sww*4&&conFlag4==1)
      {
        conFlag4=2;
        /*conTemp=conNode6;
        document.querySelector(".container").removeChild(conTemp);
        ...
        conNode24.style.opacity="0";
        conClass4=conNode20.classList[1];
        document.querySelectorAll("."+conClass4)[1].style.height="150px";
        document.querySelectorAll("."+conClass4)[1].style.width=sww+"px";
        document.querySelectorAll("."+conClass4)[1].style.opacity="1";
      ...
      if(Number(conNode20.style.left.slice(0,3))>=sww*5)
      {
        conFlag4=1;
        conTemp4=conNode20;
        conNode20=conNode19;
