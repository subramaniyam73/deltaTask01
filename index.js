...
if(screen.width>1024)
 ...
 if(screen.width>=320&&screen.width<=1024)
 {
   ...
   conNode21.classList.add("num");
   conNode1.style.top="0px";
   conNode1.style.right="520px";
   conNode2.style.top="0px";
   conNode2.style.right="390px";
   conNode3.style.top="0px";
   conNode3.style.right="260px";
   conNode4.style.top="0px";
   conNode4.style.right="130px";
   conNode5.style.top="0px";
   conNode5.style.right="0px";
   conNode21.style.top="0px";
   conNode21.style.right="-130px";
   conInterval=setInterval(function(){
     conCount++;
     conNode1.style.right=520+conCount*1+"px";
     conNode2.style.right=390+conCount*1+"px";
     conNode3.style.right=260+conCount*1+"px";
     conNode4.style.right=130+conCount*1+"px";
     conNode5.style.right=0+conCount*1+"px";
     conNode21.style.right=-130+conCount*1+"px";
     if(Number(conNode1.style.right.slice(0,3))>=520&&conFlag==1)
     {
       conFlag=2;
       /*conTemp=conNode6;
       document.querySelector(".container").removeChild(conTemp);
       ...
       document.querySelectorAll("."+conClass)[1].style.width="130px";
       document.querySelectorAll("."+conClass)[1].style.opacity="1";
     ...
     if(Number(conNode1.style.right.slice(0,3))>=650)
     {
       conFlag=1;
       conTemp=conNode1;
       conNode1=conNode2;
   ...
   conNode7.style.left="130px";
   conNode8.style.top="200px";
   conNode8.style.left="260px";
   conNode9.style.top="200px";
   conNode9.style.left="390px";
   conNode10.style.top="200px";
   conNode10.style.left="520px";
   conNode22.style.top="200px";
   conNode22.style.left="-130px";
   conInterval2=setInterval(function(){
     conNode6.style.top="200px";
     ...
     conCount2++;
     conNode10.style.left=520+conCount2*1+"px";
     conNode9.style.left=390+conCount2*1+"px";
     conNode8.style.left=260+conCount2*1+"px";
     conNode7.style.left=130+conCount2*1+"px";
     conNode6.style.left=0+conCount2*1+"px";
     conNode22.style.left=-130+conCount2*1+"px";
     if(Number(conNode10.style.left.slice(0,3))>=520&&conFlag2==1)
     {
       conFlag2=2;
       /*conTemp=conNode6;
       document.querySelector(".container").removeChild(conTemp);
       ...
       document.querySelectorAll("."+conClass2)[1].style.width="130px";
       document.querySelectorAll("."+conClass2)[1].style.opacity="1";
     ...
     if(Number(conNode10.style.left.slice(0,3))>=650)
     {
       conFlag2=1;
       conTemp2=conNode10;
       conNode10=conNode9;
   ...
   conNode23.classList.add("num");
   conNode11.style.top="0px";
   conNode11.style.right="520px";
   conNode12.style.top="0px";
   conNode12.style.right="390px";
   conNode13.style.top="0px";
   conNode13.style.right="260px";
   conNode14.style.top="0px";
   conNode14.style.right="130px";
   conNode15.style.top="0px";
   conNode15.style.right="0px";
   conNode23.style.top="0px";
   conNode23.style.right="-130px";
   conInterval3=setInterval(function(){
     ...
     conCount3++;
     conNode11.style.right=520+conCount3*1+"px";
     conNode12.style.right=390+conCount3*1+"px";
     conNode13.style.right=260+conCount3*1+"px";
     conNode14.style.right=130+conCount3*1+"px";
     conNode15.style.right=0+conCount3*1+"px";
     conNode23.style.right=-130+conCount3*1+"px";
     if(Number(conNode11.style.right.slice(0,3))>=520&&conFlag3==1)
     {
       conFlag3=2;
       /*conTemp=conNode6;
       document.querySelector(".container").removeChild(conTemp);
       ...
       document.querySelectorAll("."+conClass3)[1].style.width="130px";
       document.querySelectorAll("."+conClass3)[1].style.opacity="1";
     ...
     if(Number(conNode11.style.right.slice(0,3))>=650)
     {
       conFlag3=1;
       conTemp3=conNode11;
       conNode11=conNode12;
   ...
   conNode17.style.left="130px";
   conNode18.style.top="600px";
   conNode18.style.left="260px";
   conNode19.style.top="600px";
   conNode19.style.left="390px";
   conNode20.style.top="600px";
   conNode20.style.left="520px";
   ...
   conInterval4=setInterval(function(){
     ...
     conCount4++;
     conNode20.style.left=520+conCount4*1+"px";
     conNode19.style.left=390+conCount4*1+"px";
     conNode18.style.left=260+conCount4*1+"px";
     conNode17.style.left=130+conCount4*1+"px";
     conNode16.style.left=0+conCount4*1+"px";
     conNode24.style.left=-130+conCount4*1+"px";
     if(Number(conNode20.style.left.slice(0,3))>=520&&conFlag4==1)
     {
       conFlag4=2;
       /*conTemp=conNode6;
       document.querySelector(".container").removeChild(conTemp);
       ...
       document.querySelectorAll("."+conClass4)[1].style.width="130px";
       document.querySelectorAll("."+conClass4)[1].style.opacity="1";
     ...
     if(Number(conNode20.style.left.slice(0,3))>=650)
     {
       conFlag4=1;
       conTemp4=conNode20;
       conNode20=conNode19;
