...
if(screen.width>1024)
  ...
  if(screen.width>=320&&screen.width<=1024)
  {
    ...
    conNode21.classList.add("num");
    conNode1.style.top="0px";
    conNode1.style.right="800px";
    conNode2.style.top="0px";
    conNode2.style.right="600px";
    conNode3.style.top="0px";
    conNode3.style.right="400px";
    conNode4.style.top="0px";
    conNode4.style.right="200px";
    conNode5.style.top="0px";
    conNode5.style.right="0px";
    conNode21.style.top="0px";
    conNode21.style.right="-200px";
    conInterval=setInterval(function(){
      conCount++;
      conNode1.style.right=800+conCount*1+"px";
      conNode2.style.right=600+conCount*1+"px";
      conNode3.style.right=400+conCount*1+"px";
      conNode4.style.right=200+conCount*1+"px";
      conNode5.style.right=0+conCount*1+"px";
      conNode21.style.right=-200+conCount*1+"px";
      if(Number(conNode1.style.right.slice(0,3))>=800&&conFlag==1)
      {
        conFlag=2;
        /*conTemp=conNode6;
        document.querySelector(".container").removeChild(conTemp);
        ...
        document.querySelectorAll("."+conClass)[1].style.width="200px";
        document.querySelectorAll("."+conClass)[1].style.opacity="1";
      ...
      if(Number(conNode1.style.right.slice(0,3))>=1000)
      {
        conFlag=1;
        conTemp=conNode1;
        conNode1=conNode2;
    ...
    conNode7.style.left="200px";
    conNode8.style.top="200px";
    conNode8.style.left="400px";
    conNode9.style.top="200px";
    conNode9.style.left="600px";
    conNode10.style.top="200px";
    conNode10.style.left="800px";
    conNode22.style.top="200px";
    conNode22.style.left="-200px";
    conInterval2=setInterval(function(){
      conNode6.style.top="200px";
      ...
      conCount2++;
      conNode10.style.left=800+conCount2*1+"px";
      conNode9.style.left=600+conCount2*1+"px";
      conNode8.style.left=400+conCount2*1+"px";
      conNode7.style.left=200+conCount2*1+"px";
      conNode6.style.left=0+conCount2*1+"px";
      conNode22.style.left=-200+conCount2*1+"px";
      if(Number(conNode10.style.left.slice(0,3))>=800&&conFlag2==1)
      {
        conFlag2=2;
        /*conTemp=conNode6;
        document.querySelector(".container").removeChild(conTemp);
        ...
        document.querySelectorAll("."+conClass2)[1].style.width="200px";
        document.querySelectorAll("."+conClass2)[1].style.opacity="1";
      ...
      if(Number(conNode10.style.left.slice(0,3))>=1000)
      {
        conFlag2=1;
        conTemp2=conNode10;
        conNode10=conNode9;
    ...
    conNode11.style.right="800px";
    conNode12.style.top="400px";
    conNode12.style.right="600px";
    conNode13.style.top="400px";
    conNode13.style.right="400px";
    conNode14.style.top="400px";
    conNode14.style.right="200px";
    conNode15.style.top="400px";
    conNode15.style.right="0px";
    conNode23.style.top="400px";
    conNode23.style.right="-200px";
    conInterval3=setInterval(function(){
      conCount3++;
      conNode11.style.right=800+conCount3*1+"px";
      conNode12.style.right=600+conCount3*1+"px";
      conNode13.style.right=400+conCount3*1+"px";
      conNode14.style.right=200+conCount3*1+"px";
      conNode15.style.right=0+conCount3*1+"px";
      conNode23.style.right=-200+conCount3*1+"px";
      if(Number(conNode11.style.right.slice(0,3))>=800&&conFlag3==1)
      {
        conFlag3=2;
        /*conTemp=conNode6;
        document.querySelector(".container").removeChild(conTemp);
        ...
        document.querySelectorAll("."+conClass3)[1].style.width="200px";
        document.querySelectorAll("."+conClass3)[1].style.opacity="1";
      ...
      if(Number(conNode11.style.right.slice(0,3))>=1000)
      {
        conFlag3=1;
        conTemp3=conNode11;
        conNode11=conNode12;
    ...
    conNode17.style.left="200px";
    conNode18.style.top="600px";
    conNode18.style.left="400px";
    conNode19.style.top="600px";
    conNode19.style.left="600px";
    conNode20.style.top="600px";
    conNode20.style.left="800px";
    conNode24.style.top="600px";
    conNode24.style.left="-200px";
    conInterval4=setInterval(function(){
      ...
      conCount4++;
      conNode20.style.left=800+conCount4*1+"px";
      conNode19.style.left=600+conCount4*1+"px";
      conNode18.style.left=400+conCount4*1+"px";
      conNode17.style.left=200+conCount4*1+"px";
      conNode16.style.left=0+conCount4*1+"px";
      conNode24.style.left=-200+conCount4*1+"px";
      if(Number(conNode20.style.left.slice(0,3))>=800&&conFlag4==1)
      {
        conFlag4=2;
        /*conTemp=conNode6;
        document.querySelector(".container").removeChild(conTemp);
        ...
        document.querySelectorAll("."+conClass4)[1].style.width="200px";
        document.querySelectorAll("."+conClass4)[1].style.opacity="1";
      ...
      if(Number(conNode20.style.left.slice(0,3))>=1000)
      {
        conFlag4=1;
        conTemp4=conNode20;
        conNode20=conNode19;
